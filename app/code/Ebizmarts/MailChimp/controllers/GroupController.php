...
namespace code\Ebizmarts\MailChimp\controllers-1.1.22\mc - magento - 1.1.22\app\code\community\Ebizmarts\MailChimp\controllers;
use code\Ebizmarts\MailChimp\Helper\Ebizmarts_MailChimp_Helper_Data;use Ebizmarts_Mailchimp4Magento\Exception;use Ebizmarts_Mailchimp4Magentouseuse;use Ebizmarts_MailChimp_Helper_Date;use Ebizmarts_MailChimp_Model_Api_Subscribers;use Ebizmarts_MailChimp_Model_Interestgroup;use Mage;use Mage_Core_Controller_Front_Action;use Mage_Core_Helper_Abstract;use Mage_Core_Model_Session;use Mage_Newsletter_Model_Subscriber;use Mage_Sales_Model_Order; Ebizmarts_MailChimp_Helper_Data; Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magento
/**
