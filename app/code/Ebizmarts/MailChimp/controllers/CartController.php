...
use code\Ebizmarts\MailChimp\Model\Ebizmarts_MailChimp_Model_Config;use Ebizmarts_Mailchimp4Magentouseuse;use Mage;use Mage_Checkout_CartController; Ebizmarts_MailChimp_Model_Config; Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magentorequire_once Mage::getModuleDir('controllers', 'Mage_Checkout') . DS . 'CartController.php';
