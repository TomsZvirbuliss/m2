...
namespace code\Ebizmarts\MailChimp\Block\Checkout\Success-1.1.22\mc - magento - 1.1.22\app\code\community\Ebizmarts\MailChimp\Block\Checkout\Success;
use code\Ebizmarts\MailChimp\Helper\Ebizmarts_MailChimp_Helper_Data;use Ebizmarts_Mailchimp4Magentouseuse;use Mage;use Mage_Core_Block_Template;use Mage_Core_Exception;use Mage_Core_Helper_Abstract;use Mage_Core_Model_Abstract;use Mage_Core_Model_Store_Exception;use Mage_Sales_Model_Order;use MailChimp_Error; Ebizmarts_MailChimp_Helper_Data; Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magento
