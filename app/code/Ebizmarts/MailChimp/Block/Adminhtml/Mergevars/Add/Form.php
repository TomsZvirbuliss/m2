...
namespace code\Ebizmarts\MailChimp\Block\Adminhtml\Mergevars\Add Mage;

use Ebizmarts_Mailchimp4Magentouse\Mage;
use Mage_Adminhtml_Block_Widget_Form;
use Varien_Data_Form;

-1.1.22\mc - magento - 1.1.22\app\code\community\Ebizmarts\MailChimp\Block\Adminhtml\Mergevars\Add;
/**
