...
namespace code\Ebizmarts\MailChimp\Helper Mage_Core_Helper_Abstract;

use Ebizmarts_Mailchimp4Magentouse\Exception;
use Ebizmarts_Mailchimp4Magentouse\Mage_Core_Helper_Abstract;
use Mage_HTTP_Client_Curl;
use Zend_Http_Client;

-1.1.22\mc - magento - 1.1.22\app\code\community\Ebizmarts\MailChimp\Helper;
/**
 *
