...
namespace code\Ebizmarts\MailChimp\Model\Api\Subscribers-1.1.22\mc - magento - 1.1.22\app\code\community\Ebizmarts\MailChimp\Model\Api\Subscribers;
use;use code\Ebizmarts\MailChimp\Helper\Ebizmarts_MailChimp_Helper_Data;use Ebizmarts_Mailchimp4Magento\Exception;use Ebizmarts_Mailchimp4Magento\return;use Ebizmarts_Mailchimp4Magentouseuse;use Ebizmarts_MailChimp_Helper_Date;use Ebizmarts_MailChimp_Helper_Webhook;use Ebizmarts_MailChimp_Model_Api_Subscribers_InterestGroupHandle;use Ebizmarts_MailChimp_Model_Config;use Mage;use Mage_Core_Exception;use Mage_Core_Model_Abstract;use Mage_Core_Model_Store_Exception;use Mage_Customer_Model_Customer;use Mage_Newsletter_Model_Subscriber;use Mage_Sales_Model_Order;use MailChimp_Error;use returns;use Varien_Object;use function Ebizmarts_Mailchimp4Magento\count; Ebizmarts_MailChimp_Helper_Data; Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magento
/**
...
class Ebizmarts_MailChimp_Model_Api_Subscribers_MailchimpTags
{
    ...
    /**
     * @var \code\Ebizmarts\MailChimp\Model\Api\Subscribers\Ebizmarts_MailChimp_Model_Api_Subscribers_InterestGroupHandle
     */
