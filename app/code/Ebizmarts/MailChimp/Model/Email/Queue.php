...
use Ebizmarts_Mailchimp4Magento\Exception;use Ebizmarts_Mailchimp4Magento\Mage;use Ebizmarts_Mailchimp4Magentouseuse;use Mage_Core_Model_Abstract;use Mage_Core_Model_Email_Queue;use Mage_Core_Model_Resource_Email_Queue_Collection;use Mandrill_Message;use Varien_Object;use Zend_Mail;use Zend_Mail_Exception;use Zend_Mail_Transport_Sendmail; Mage; Ebizmarts_Mailchimp4Magento
/**
