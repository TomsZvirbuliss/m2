...
use code\Ebizmarts\MailChimp\Helper\Ebizmarts_MailChimp_Helper_Data;use Ebizmarts_Mailchimp4Magento\Exception;use Ebizmarts_Mailchimp4Magentouseuse;use Ebizmarts_MailChimp_Helper_Date;use Ebizmarts_MailChimp_Model_Api_Subscribers_InterestGroupHandle;use Ebizmarts_MailChimp_Model_Api_Subscribers_MailchimpTags;use Ebizmarts_MailChimp_Model_Config;use Ebizmarts_MailChimp_Model_Subscriber;use Mage;use Mage_Core_Exception;use Mage_Core_Helper_Abstract;use Mage_Core_Model_Abstract;use Mage_Newsletter_Model_Subscriber; Ebizmarts_MailChimp_Helper_Data; Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magentouse Ebizmarts_Mailchimp4Magento
...
class Ebizmarts_MailChimp_Model_ProcessWebhook
{
    ...
    /**
     * @var \code\Ebizmarts\MailChimp\Model\Api\Subscribers\Ebizmarts_MailChimp_Model_Api_Subscribers_MailchimpTags
     */
    protected $_tags;
    ...
    /**
     * @return \code\Ebizmarts\MailChimp\Model\Api\Subscribers\Ebizmarts_MailChimp_Model_Api_Subscribers_MailchimpTags
     */
